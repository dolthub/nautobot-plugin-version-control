...
# ------------------------------------------------------------------------------
# E2E - these tasks are for running tests or starting services, and performs all
...
@task
def e2e_tests(context, use_hosted_dolt=False):
    """Run all tests for this plugin."""
    if use_hosted_dolt:
...
@task
def e2e_start(context, use_hosted_dolt=False):
